  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      <div className="container mx-auto px-6 py-12">
        ...
        >
          <h1 className="text-4xl font-bold mb-8 text-pink-500">Privacy Policy for Crew Hive</h1>
          <div className="space-y-6 text-gray-300">
            <section>
              <p className="text-lg font-semibold mb-4">Last updated: January 04, 2025</p>
            ...
            <section>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Interpretation</h3>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Definitions</h3>
              <div className="space-y-2">
                <p>For the purposes of this Privacy Policy:</p>
                <ul className="list-disc pl-8 space-y-2">
                    <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                    <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                    <li><strong>Application</strong> refers to Crew Hive, the software program provided by the Company.</li>
                    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Codelirium Labs LLC, 1209 MOUNTAIN ROAD PL NE STE N.</li>
            ...
            <section>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Types of Data Collected</h3>
              
              <h4 className="text-lg font-bold mb-2 text-white">Personal Data</h4>
              ...
              <h4 className="text-lg font-bold mb-2 text-white">Usage Data</h4>
              ...
              <h4 className="text-lg font-bold mb-2 text-white">Information Collected while Using the Application</h4>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Use of Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Retention of Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Transfer of Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Delete Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Disclosure of Your Personal Data</h2>
              <h3 className="text-xl font-bold mb-2 text-white">Business Transactions</h3>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Law enforcement</h3>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Other legal requirements</h3>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white">Security of Your Personal Data</h2>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                <a href="mailto:info@codeliriumlabs.com" className="text-pink-500 hover:text-pink-400">
                  info@codeliriumlabs.com
                </a>
              </p>
            </section>
          </div>
